...
export const TRIGGERS = {
  ...
  "LENDING": {
    ...
    "MORPHO": {
      ...
      "image": "https://otomato-sdk-images.s3.eu-west-1.amazonaws.com/morpho.png",
      "LENDING_RATE": {
        "name": "Lending rate",
    ...
    "MORPHO": {
      ...
      "BORROW": {
        ...
        "examples": [
          {
            "name": "Borrow 100 USDC",
            "description": "Borrow 100 USDC from market USDz/USDC on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
              ...
              },
              {
                ...
                "value": "0x58bf7ed35b5d213336a68a5a42dff58f03ceaf417edaad0fc53e046f1742e20e"
              }
            ]
          },
          {
            "name": "Borrow 10 DEGEN",
            "description": "Borrow 10 DEGEN from market USDC/DEGEN on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
              ...
              {
                "key": "abiParams.marketId",
                "value": "0x6bac0f6c8b598a04e839a3fc048212291909c40181ee7a0da942ca5c5203a4b1"
              }
            ]
          }
        ],
      ...
      "REPAY": {
        ...
        "examples": [
          {
            "name": "Repay 100 USDC",
            "description": "Repay 100 USDC to market USDZ/USDC on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
          ...
          {
            "name": "Repay 10 DEGEN",
            "description": "Repay 10 USDC to market USDC/DEGEN on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
      ...
      "SUPPLY_COLLATERAL": {
        ...
        "examples": [
          {
            "name": "Supply 100 USDz as Collateral",
            "description": "Supply 100 USDz as Collateral to market USDz/USDC on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
          ...
          },
          {
            ...
            "description": "Supply 100 USDC as Collateral to market USDC/DEGEN on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
      ...
      "WITHDRAW_COLLATERAL": {
        ...
        "examples": [
          {
            "name": "Withdraw 100 collateral USDz",
            "description": "Withdraw 100 collateral USDz from market USDz/USDC on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
          ...
          },
          {
            ...
            "description": "Withdraw 100 Collateral USDC from market USDC/DEGEN on Morpho on Base",
            "parameters": [
              {
                "key": "chainId",
                "value": 8453
