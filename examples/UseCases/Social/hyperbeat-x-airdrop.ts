...
async function hyperbeat() {
  ...
  telegramSendMessageAction.setParams('message', `HyperBeat protocol alert: a tweet mentionning airdrop claim has been posted ${xXPostTriggerTrigger.getOutputVariableName('tweetURL')}`);
