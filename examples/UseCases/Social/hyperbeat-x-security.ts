...
async function hyperbeat() {
  ...
  const workflow = new Workflow('Get notified when Hyperbeat a tweet mentionning security alerts', [xXPostTriggerTrigger, aiAiAction, conditionIfAction, telegramSendMessageAction], [edge1, edge2, edge3], null);
