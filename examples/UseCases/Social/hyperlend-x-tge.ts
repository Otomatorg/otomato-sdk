...
async function hyperlend() {
  ...
  const workflow = new Workflow('Get notified when Hyperlend mentions TGE', [xXPostTriggerTrigger, aiAiAction, conditionIfAction, telegramSendMessageAction], [edge1, edge2, edge3], {
