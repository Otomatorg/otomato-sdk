...
async function hyperbeat() {
  ...
  const workflow = new Workflow('Get notified when Hyperbeat mentions TGE', [xXPostTriggerTrigger, aiAiAction, conditionIfAction, telegramSendMessageAction], [edge1, edge2, edge3], {
