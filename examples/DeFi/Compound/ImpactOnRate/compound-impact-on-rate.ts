...
async function compound_impact_on_rate() {
  ...
  const predictImpactOnLendingRateTrigger = new Trigger(TRIGGERS.LENDING.COMPOUND.PREDICT_IMPACT_ON_LENDING_RATE);
  ...
  const workflow = new Workflow(
    "Compound impact on lending rate",
    [
