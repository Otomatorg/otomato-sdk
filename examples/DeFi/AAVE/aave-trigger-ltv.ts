import { 
  ...
  async function aave_trigger_ltv_slack() {
    ...
    aaveLTVTrigger.setChainId(CHAINS.BASE);
    ...
    slackMessageAction.setParams("message", "AAVE LTV trigger fired for wallet 0x9332D0cE5D45184515e0EA85bf9f4af09Cbf10Af");
