...
async function moonwell_impact_on_rate() {
  ...
  const predictImpactOnLendingRateTrigger = new Trigger(TRIGGERS.LENDING.MOONWELL.PREDICT_IMPACT_ON_LENDING_RATE);
  ...
  const workflow = new Workflow(
    "Moonwell impact on lending rate",
    [
