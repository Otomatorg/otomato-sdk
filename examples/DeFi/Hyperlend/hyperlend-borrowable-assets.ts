...
async function borrowable_assets() {
  ...
  borrowableAssetsTrigger.setChainId(CHAINS.HYPER_EVM);
  borrowableAssetsTrigger.setParams("abiParams.asset", getTokenFromSymbol(CHAINS.HYPER_EVM, 'wHYPE').contractAddress);
